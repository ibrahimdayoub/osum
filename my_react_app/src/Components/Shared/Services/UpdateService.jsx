...
import { updateService } from '../../../Redux/Features/Services/servicesSlice';
import { FaBoxOpen, FaEdit, FaSpinner } from "react-icons/fa"
import { toastify } from '../../../Helper';

const UpdateService = ({ service, setShowUpdate }) => {
    ...
    const [serviceInput, setServiceInput] = useState({
        ...
        expected_coast: service.expected_coast,
        expected_duration: service.expected_duration,
        service_experiences: service.service_experiences.join(","),
        experiences_links: service.experiences_links.join(",")
    });
    ...
    const updateServiceSubmit = (e) => {
        ...
        dispatch(updateService({ id: service._id, data }))
        setShowUpdateAlt(true)
    }
    useEffect(() => {
        if ((Date.now() - servicesState.time < 100) && servicesState.status === 200 && servicesState.message && servicesState.operation === "updateService") {
            toastify("success", servicesState.status, servicesState.message)
            if (showUpdateAlt) {
                setShowUpdate('')
            }
        }
        else if ((Date.now() - servicesState.time < 100) && (servicesState.status === 400 || servicesState.status === 401 || servicesState.status === 403 || servicesState.status === 404) && servicesState.message && servicesState.operation === "updateService") {
            toastify("error", servicesState.status, servicesState.message)
        }
        else if ((Date.now() - servicesState.time < 100) && servicesState.status === 500 && servicesState.message && servicesState.operation === "updateService") {
    ...
    return (
        <div className="bg-dark/[0.025] dark:bg-light/[0.025] p-4 mt-2 mb-1 rounded-md">
            <h2 className="text-dark dark:text-light text-base">
                ...
                Update your service and work with all:
            </h2>
            <form onSubmit={(e) => { updateServiceSubmit(e) }} className="max-w-5xl mx-auto">
                <div className="my-2">
                    <div className="mb-1">
                        ...
                        <input
                            ...
                            name="service_name"
                            className={
                                servicesState.errors && servicesState.errors.service_name && servicesState.operation === "updateService" ?
                            ...
                            placeholder={servicesState.errors && servicesState.errors.service_name && servicesState.operation === "updateService" ? servicesState.errors.service_name : "What its name ?"}
                        />
                    </div>
                    {
                            ...
                            <>
                                <div className="mb-1">
                                    ...
                                    <input
                                        ...
                                        className={
                                            servicesState.errors && servicesState.errors.service_description && servicesState.operation === "updateService" ?
                                                "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs" :
                                                "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs"
                                        }
                                        placeholder={servicesState.errors && servicesState.errors.service_description && servicesState.operation === "updateService" ? servicesState.errors.service_description : "Service Description"}
                                    />
                                </div>
                                <div className="mb-1">
                                    ...
                                    <input
                                        ...
                                        name="expected_coast"
                                        className={
                                            servicesState.errors && servicesState.errors.expected_coast && servicesState.operation === "updateService" ?
                                                "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs" :
                                                "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs"
                                        }
                                        placeholder={servicesState.errors && servicesState.errors.expected_coast && servicesState.operation === "updateService" ? servicesState.errors.expected_coast : "Total Coast"}
                                    />
                                </div>
                                <div className="mb-1">
                                    ...
                                    <input
                                        ...
                                        className={
                                            servicesState.errors && servicesState.errors.expected_duration && servicesState.operation === "updateService" ?
                                                "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs" :
                                                "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs"
                                        }
                                        placeholder={servicesState.errors && servicesState.errors.expected_duration && servicesState.operation === "updateService" ? servicesState.errors.expected_duration : "Expected Duration"}
                                    />
                                </div>
                                <div className="mb-1">
                                    ...
                                    <input
                                        ...
                                        className={
                                            servicesState.errors && servicesState.errors.service_experiences && servicesState.operation === "updateService" ?
                                                "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs" :
                                                "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs"
                                        }
                                        placeholder={servicesState.errors && servicesState.errors.service_experiences && servicesState.operation === "updateService" ? servicesState.errors.service_experiences : "Service experiences and separate it by comma !"}
                                    />
                                </div>
                                <div className="mb-1">
                                    ...
                                    <input
                                        ...
                                        className={
                                            servicesState.errors && servicesState.errors.experiences_links && servicesState.operation === "updateService" ?
                                                "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs" :
                                                "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-xs"
                                        }
                                        placeholder={servicesState.errors && servicesState.errors.experiences_links && servicesState.operation === "updateService" ? servicesState.errors.experiences_links : "Experiences links and separate it by comma !"}
                                    />
                                </div>
                            </> :
                            null
                    ...
                    serviceInput.service_name || serviceInput.service_description || serviceInput.expected_coast || serviceInput.expected_duration || serviceInput.service_experiences ?
                        <div className='flex justify-end'>
                            <button type="submit" className="text-dark dark:text-light bg-dark/[0.05] dark:bg-light/[0.05] border-b-[2.5px] border-queen dark:border-king shadow-inner shadow-dark/10 dark:shadow-light/10 hover:opacity-75 py-1 transition-all duration-500 cursor-pointer text-xs rounded-md min-w-[150px]">
                                {
                                    servicesState.isLoading && servicesState.operation === "updateService" ? <FaSpinner className="inline text-xs mr-1 mb-0.5" /> :
                                        <>
