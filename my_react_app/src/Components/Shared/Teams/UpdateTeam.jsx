...
import { updateTeam } from '../../../Redux/Features/Teams/teamsSlice';
import { FaCrown, FaEdit, FaList, FaSpinner, FaTimes } from 'react-icons/fa';
import { toastify } from '../../../Helper';

const UpdateTeam = ({ isOpenTeams, setSearchParams, currentTeam, setCurrentTeam, setUpdatedTeam }) => {
    ...
    const [teamInput, setTeamInput] = useState({
        ...
        team_description: currentTeam.team_description,
        field_of_work: currentTeam.field_of_work
    });
    const [teamMembers, setTeamMembers] = useState(currentTeam.members_ids);
    ...
    const updateTeamSubmit = (e) => {
        ...
        dispatch(updateTeam({ id: currentTeam._id, data: formData }))
    }
    useEffect(() => {
        if ((Date.now() - teamsState.time < 100) && teamsState.status === 200 && teamsState.message && teamsState.operation === "updateTeam") {
        ...
        else if ((Date.now() - teamsState.time < 100) && (teamsState.status === 400 || teamsState.status === 401 || teamsState.status === 403 || teamsState.status === 404) && teamsState.message && teamsState.operation === "updateTeam") {
            toastify("error", teamsState.status, teamsState.message)
        }
        else if ((Date.now() - teamsState.time < 100) && teamsState.status === 500 && teamsState.message && teamsState.operation === "updateTeam") {
    ...
    return (
        <div className="text-dark/50 dark:text-light/50 text-left text-xs sm:text-lg py-1 px-1 ml-1">
            <form encType="multipart/form-data" onSubmit={(e) => { updateTeamSubmit(e) }}>
                <div>
                    <div className="mb-1">
                        ...
                        <input
                            ...
                            name="team_name"
                            className={
                                teamsState.errors && teamsState.errors.team_name && teamsState.operation === "updateTeam" ?
                            ...
                            placeholder={teamsState.errors && teamsState.errors.team_name && teamsState.operation === "updateTeam" ? teamsState.errors.team_name : "Team Name"}
                        />
                    </div>
                    <div className="mb-1">
                        ...
                        <input
                            ...
                            className={
                                teamsState.errors && teamsState.errors.team_description && teamsState.operation === "updateTeam" ?
                                    "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-sm" :
                                    "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-sm"
                            }
                            placeholder={teamsState.errors && teamsState.errors.team_description && teamsState.operation === "updateTeam" ? teamsState.errors.team_description : "Team Description"}
                        />
                    </div>
                    <div className="mb-1">
                        ...
                        <input
                            ...
                            className={
                                teamsState.errors && teamsState.errors.members_ids && teamsState.operation === "updateTeam" ?
                                    "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-sm" :
                                    "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-sm"
                            }
                            placeholder={teamsState.errors && teamsState.errors.members_ids && teamsState.operation === "updateTeam" ? teamsState.errors.members_ids : "Team Members"}
                        />
                    </div>
                    <div className={
                        isOpenTeams ?
                    ...
                    <div className="mb-1">
                        <select
                            ...
                            name="field_of_work"
                            className={
                                teamsState.errors && teamsState.errors.field_of_work && teamsState.operation === "updateTeam" ?
                    ...
                    <div className="mb-1">
                        <label htmlFor="team_picture"
                            className={
                                teamsState.errors && teamsState.errors.team_picture && teamsState.operation === "updateTeam" ?
                                    "placeholder-danger/50 dark:placeholder-danger/50 text-danger dark:text-danger bg-transparent border-b border-danger/50 dark:border-danger/50 focus:border-danger dark:focus:border-danger py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-sm" :
                                    "placeholder-dark/50 dark:placeholder-light/50 text-dark dark:text-light bg-transparent border-b border-dark/50 dark:border-light/50 focus:border-dark dark:focus:border-light py-1 relative block w-full appearance-none px-2 focus:z-10 focus:outline-none sm:text-sm"
                            }
                        >
                            {
                                teamsState.errors && teamsState.errors.team_picture && teamsState.operation === "updateTeam" ?
                                    ...
                                    teamPicture && teamPicture.name ?
                                        ...
                                        <span className="text-dark/50 dark:text-light/50">New Picture</span>
                            }
                        </label>
                        <input
                ...
                >
                    {
                        teamsState.isLoading && teamsState.operation === "updateTeam" ? <FaSpinner className="inline text-xl animate-spin" /> :
                            <>
                                <FaEdit className="inline text-xs mr-1 mb-0.5" />
                                {
                                    isOpenTeams ?
                                        <span className="inline text-xs md:text-sm">Update Team {teamMembers.length > 0 ? `(${teamMembers.length})` : null}</span> :
                                        <span className="hidden sm:inline text-xs md:text-sm">Update Team {teamMembers.length > 0 ? `(${teamMembers.length})` : null}</span>
                                }
                            </>
                    }
                </button>
